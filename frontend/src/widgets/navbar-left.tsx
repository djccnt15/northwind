...
export default function LeftNavBar() {
  ...
  return (
    <Nav>
      ...
      {(user?.authorities.includes("ADMIN") ||
        user?.authorities.includes("STOCK")) && (
        <NavLink to="/stock-take">
          <NavItem>
            <svg
              fill="none"
              strokeWidth={1.5}
      ...
      {(user?.authorities.includes("ADMIN") ||
        user?.authorities.includes("ORDER")) && (
        <NavLink to="/orders">
          <NavItem>
            <svg
              fill="none"
      ...
      {(user?.authorities.includes("ADMIN") ||
        ...
        <NavList>
          <NavLink to="/admin/categories">
            <NavItem>
              {ConfigIcon}
              {t("nav.admin.category")}
            </NavItem>
          </NavLink>
        </NavList>
      )}
      {/* TODO. rm this menu for production */}
      {user?.authorities.includes("ADMIN") && (
        <a
      ...
      <NavItem as="button" type="button" className="log-out" onClick={onLogout}>
        <svg
          fill="none"
          strokeWidth={1.5}
          stroke="currentColor"
